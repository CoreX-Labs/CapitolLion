...
const notify = () =>
  toast("Notification set successfully", {
    ...
    style: {
      ...
      background: "#121212",
      boxShadow:
        "1px 1px 29px 3px rgba(91, 46, 157, 0.3), inset 0px 4px 50px rgba(0, 0, 0, 0.8)",
      fontSize: "18px",
...
export const Launchpad = () => {
  ...
  const setNotification = () => {
    notify();
  	...
  	const BlindMint = async () => {
		const contract = await window.tronWeb
      .contract()
      .at("TRHV5wRC1RTG1kSkPAY1RHmyXihoJCKDn3");

	  await contract.BlindMint(address.address, 111).send({
  ...
  return (
    <Container>
      ...
      <Sub>
        <div>
          <p className="orbitron-light font-[400] text-[14px] leading-[26px] pb-[25px] capitalize">
            OneM1nd
          </p>
        </div>
        <div>
        ...
        <div className="pb-[12px]">
          <HeroButtonOne>
            <a
              href="https://kraftly.io/mintable/111/gallery?page=1"
              target="_blank"
              rel="noreferrer"
              className="tracking-wide orbitron-light"
            >
              View Song
            </a>
          </HeroButtonOne>
        ...
        <div className="tracking-widest orbitron-light pb-[30px]">
          <HeroButtonTwo onClick={() => BlindMint()}>
            {/* <div>
              <img src="/bell.png" alt="Bell Icon" />
            </div> */}
            <div>
              <p className="tracking-wide orbitron-light">Mint Now</p>
            </div>
          </HeroButtonTwo>
        </div>
        {/*  */}
        ...
        <section className="timer">
          <div className="time">
            <section>
              ...
              <h3>
                <small className="font-[400] text-[12px] leading-[14px] orbitron-light">
                  Days
                </small>
              </h3>
            </section>
            <span className="font-[400] text-[52px] leading-[52px] -mt-[30px]">
              :
            </span>
            <section>
              <h3 className="orbitron-header font-[400] text-[43px] leading-[52px] tracking-wider">
