...
const MusicDAO = () => {
  ...
  //   const tx = await contract.getUserTokens("TBkdYhMjwQXHH7QULtX2qXT6oTXMgTgm9r").call(
  //     {feeLimit:200_000_000,callValue:0, shouldPollResponse:false}
        ...
        <div className="py-12 md:container md:grid md:grid-cols-2 md:px-40">
          ...
          <div className="p-5">
            ...
            <p className="white justifier txtabout">
              ...
              productivity of the Evolution of Music.
            </p>
          </div>
        </div>
          ...
          <div>
            <div className="boxModel">
              ...
              <div className="boxbody">
                ...
                <p className="mt-5 text-center white">
                  Buy & Sale Native NFTs
                  <br />
                  Build Catalog of NFTs
                  <br />
                </p>
              </div>
            </div>
