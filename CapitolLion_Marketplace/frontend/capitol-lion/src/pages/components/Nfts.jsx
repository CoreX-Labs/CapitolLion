...
const Nfts = () => {
  ...
  return (
    <React.Fragment>
      <div>
        <h1 className='text-center font-[500] text-[36px] leading-[80px] orbitron-light pb-[42px]'>Popular Items</h1>
              ...
              <div key={ idx } className="w-[305.23px] h-[421.25px] rounded-[20px] nft__div">
                ...
                <div className="flex">
                  ...
                  <div className="pt-[18.75px]">
                    <motion.button whileTap={{ scale: -0.5 }} className="capitalize transition-all bid__button orbitron-light">bid</motion.button>
