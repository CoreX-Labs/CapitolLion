  ...
  return (
    <React.Fragment>
      <div className='pt-[130px] md:pt-[40px] 2xl:pt-[172px] pb-[100px] md:pb-[100px]'>
        ...
        <div className='p-8 flex items-center justify-center pt-[49px]'>
          <div className='w-full md:h-[210px] rounded-[20px] partner__div'>
            <div className='md:flex md:items-center md:justify-center pt-[41px] pb-[41px]'>
              {partners.map((item, idx) => (
                <div key={idx} className='w-full md:h-[128px] md:flex md:gap-[145px] md:justify-center'>
